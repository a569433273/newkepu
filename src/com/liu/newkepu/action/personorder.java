...
public class personorder extends ActionSupport implements ModelDriven<Object>{
    ...
    public String execute() throws Exception {
        ...
        for (Order order : orders) {
            ...
            order.setFlight_from(flightnameDao.findBysanzima(orders.get(0).getFlight_from()).getChengshi());
            order.setFlight_arrival(flightnameDao.findBysanzima(orders.get(0).getFlight_arrival()).getChengshi());
