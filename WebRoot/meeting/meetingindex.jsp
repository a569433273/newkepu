...
<head>
    ...
    <script type="text/javascript" src="../js/Meet_Sear.js"></script><!--搜索会议弹出框-->
</head>
<body>
<!--header部分 start-->
<div class="total">
    <div class="header">
        ...
        <div class="hd_mark"><a href=""><img src="../images/mark1.jpg" alt=""></a>&nbsp;&nbsp;<a href=""><img src="../images/mark2.jpg" alt=""></a></div>
    ...
    <form action="searchmeeting.action"  method="post" name="meetfrom" id="meetfrom">
        <div class="M_div2">
            ...
            <div class="M_d_2">
                ...
                <div class="M_d_22">
                    <div class="M_d_22_1"><p><input type="text" name="Mt_nm" style="width:200px; height:25px; border:0; color:#666; line-height:25px;" value="请输入要搜索的会议编号" onfocus="meeting_num()"  onblur="meeting_dhid()" id="Mt_nm"/></p></div>
                </div>
                <div class="M_d_23">
                    <div class="M_d_23_1"><p style="text-align:right;"><img src="../images/M_div_cnl.jpg" style="cursor:pointer;" onclick="M_Div_hid()" alt=""/></p></div><div class="M_d_23_2"><p style="text-align:left;"><input  type="image" name="" src="../images/M_div_sub.jpg" onclick="return M_Div_href()"/></p></div>
                </div>
            </div>
            <!--中间内容 over-->
            <!--底部圆角-->
