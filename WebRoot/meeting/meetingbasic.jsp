...
<head>
    ...
    <script type="text/javascript" src="../js/upd_mdetail.js"></script><!--修改信息-->
            ...
            <s:iterator value="meetings">
                <div class="prs_fna" id="pack6">
                    ...
                    <div class="mDetail_2" id="mDetail_2">
                        <p style="text-align:left; margin-top:10px; margin-left:31px;"><img src="../images/Mdetail_udp.gif" style="cursor:pointer;" onclick="upd_mdetail()" alt=""/></p>
                        <p>&nbsp;</p>
                    </div>
                </div>
            </s:iterator>
