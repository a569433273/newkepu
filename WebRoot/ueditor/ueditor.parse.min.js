(function () {
    (function () {
        UE = window.UE || {};
        var f = !!window.ActiveXObject, h = {removeLastbs: function (a) {
            return a.replace(/\/$/, "")
        }, extend: function (a, d) {
            ...
            return function (b, c, e) {
                var k = a(b, c);
                if (k)k.ready ? e && e() : k.funs.push(e); else if (d.push({doc: b, url: c.src || c.href, funs: [e]}), !b.body) {
                    e = [];
        ...
        var g = {};
        UE.parse = {register: function (a, d) {
            g[a] = d
        }, load: function (a) {
            h.each(g, function (d) {
                d.call(a, h)
    ...
    UE.parse.register("insertcode", function (f) {
        ...
        if (h.length)if ("undefined" == typeof XRegExp) {
            ...
            f.loadFile(document,
                {id: "syntaxhighlighter_js", src: g, tag: "script", type: "text/javascript", defer: "defer"}, function () {
                    f.each(h, function (a) {
    ...
    UE.parse.register("table", function (f) {
        ...
        if (a.length) {
            ...
            var d = function (a, c) {
                ...
                var r = {reversecurrent: function (a, b) {
                    return 1
    ...
    UE.parse.register("charts", function (f) {
        ...
        function a() {
            window.jQuery ? d() : f.loadFile(document, {src: c + "/third-party/jquery-1.10.2.min.js", tag: "script", type: "text/javascript",
        ...
        function d() {
            window.Highcharts ? b() : f.loadFile(document, {src: c + "/third-party/highcharts/highcharts.js", tag: "script", type: "text/javascript", defer: "defer"}, function () {
                b()
            })
        }

        function b() {
            f.loadFile(document, {src: c + "/dialogs/charts/chart.config.js", tag: "script", type: "text/javascript", defer: "defer"}, function () {
                for (var a = null, b = null, c = null, d = 0, f = k.length; d < f; d++) {
                    ...
                    $(c).highcharts($.extend({}, a, {credits: {enabled: !1}, exporting: {enabled: !1}, title: {text: b.title, x: -20}, subtitle: {text: b.subTitle, x: -20}, xAxis: {title: {text: b.xTitle}, categories: b.categories}, yAxis: {title: {text: b.yTitle}, plotLines: [
                        {value: 0, width: 1, color: "#808080"}
                    ]}, tooltip: {enabled: !0, valueSuffix: b.suffix}, legend: {layout: "vertical", align: "right", verticalAlign: "middle", borderWidth: 1}, series: b.series}))
                }
            })
        }
    ...
    UE.parse.register("list", function (f) {
        ...
        var g = [], a = {cn: "cn-1-", cn1: "cn-2-", cn2: "cn-3-", num: "num-1-", num1: "num-2-", num2: "num-3-", dash: "dash", dot: "dot"};
    ...
    UE.parse.register("vedio", function (f) {
        ...
        if (h.length || g.length) {
            ...
            window.videojs ? videojs.autoSetup() : (f.loadFile(document, {id: "video_css", tag: "link", rel: "stylesheet", type: "text/css", href: a}), f.loadFile(document, {id: "video_js", src: g, tag: "script", type: "text/javascript"}, function () {
