...
<script type="text/javascript" src="../js/page3.js"></script><!--我的航程分页效果-->
</head>
    ...
    <div class="prs_mid">
        ...
        <div class="prs_left">
            <div class="prs_le1">
                ...
                <div class="prs_le_3">
                    <ul>
                        <li class="prs_1" id="prs_1" onclick="prs_show(this.id)"><a class="li_anlk" href="personmessage.actionl">我的资料</a></li>
                        <li class="prs_1" id="prs_2" onclick="prs_show(this.id)"><a class="li_anlk" href="persontravller.action">常用乘机人</a></li>
                        <li class="prs_1" id="prs_3" onclick="prs_show(this.id)"><a class="li_anlk" href="persontcaiwu.action">财务中心</a></li>
                        <li class="prs_1" id="prs_4" onclick="prs_show(this.id)"><a class="li_anlk" href="prs_order.html">订单管理</a></li>
                        <li class="prs_clk" id="prs_5" onclick="prs_show(this.id)"><a class="li_aClk" href="#">我的航程</a></li>
        ...
        <div class="prs_right">
            ...
            <div class="prs_rt" id="prsC_5">
                ...
                <div class="prs_rt1">
                    ...
                    <div class="prs_rt1_2" id="pack1_5"><img src="../images/per_hid.jpg" style="margin-top:3px;" id="pack_5" onclick="cont_disp(this.id);"/>&nbsp;</div>
                </div>
                <!--我的航程 over-->
                <!--我的航程内容-->
                <div class="prs_fna" id="pack5">
                    <div class="prs_voyage">
                        ...
                        <div class="prs_voyage1">
                            <p>总飞行公里数：<span style="color:#f00; font-size:14px; font-weight:bold">1000</span>公里</span><span style="margin-left:40px;">总飞行时长<span style="color:#f00; font-size:14px; font-weight:bold">20</span>小时<span style="color:#f00; font-size:14px; font-weight:bold">15</span>分钟</span></p>
                        </div>
                        <!--航程头部 over-->
                        <!--航程信息-->
