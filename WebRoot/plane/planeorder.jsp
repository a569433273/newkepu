...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script src="../js/update_delay.js"></script>
    <style type="text/css">
        #air_name {
        }
    </style>
                ...
                <div class="t_1_top">
                    <div style="float:left; width:710px;">
                        ...
                        <div style="width:450px; float:left;">
                            ...
                            <div style="float:left; margin-top:2px; overflow:hidden; display:inline;">&nbsp;<input name="" type="checkbox" value="" class="usual_psg" checked="checked"/></div>
    ...
    <div class="peo1_info">
        <div class="peo1_info">
            ...
            <div class="top">
                ...
                <div style="float:left;margin-top:5px; overflow:hidden;">&nbsp;<img src="../images/auto_write.gif" style="cursor:pointer;" class="showdiv" /></div>
                <div style="float:left; line-height:30px; font-size:12px;"><span style="color:#999;">（请准确填写乘机人信息，以免在办理登机时发生问题）</span></div>
            </div>
            <div class="top2">
                <div  style="float:left; font-size:12px; width:50px;  line-height:20px;">姓名<span style="color:#f00;">*</span></div>
                <div style="float:left;">
                    <input type="text" style="width:120px;" name="ck_name" onfocus="check_name1()" onkeyup="check_name();" id="ck_name"/>
