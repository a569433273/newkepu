...
<div class="total">
    ...
    <!--header部分 over-->
    <!--登录部分 start-->
    <form action="" method="post" name="login_fr">
        <div class="login_part">
            <div class="login_left">
                <div style="float:left;">用户名：</div><div style="float:left; margin-top:-1px; display:inline;"><input type="text" name="u_name" class="input_w_h" /></div><div style="float:left; margin-left:5px; display:inline;">密码：</div><div style="float:left; margin-top:-1px; display:inline;"><input type="password" name="pwd" class="input_w_h"/></div><div style="float:left; margin-left:5px; display:inline;">验证码：</div><div style="float:left; margin-top:-1px; display:inline;"><input type="text" name="id_code" class="input_w_h"/></div>
            </div>
            <div class="lg_mid">
                <span onclick="createCode()" id="checkCode" class="unchanged" style="width: 45px; height:15px;  display:inline-block; "></span>
            </div>
            <div class="login_right">
                <input type="image" name="login" src="images/login.jpg"/>&nbsp;&nbsp;&nbsp;<input name="reg" type="image" src="images/reg.jpg"/>
            </div>
            <div style="clear:both;"></div>
        </div>
    </form>
        ...
        <div style="width:795px; heigth:auto; overflow:hidden; float:left;">
            <div class="in_left">
                ...
                <div class="in_left1" style="margin-left:20px;">
                    ...
                    <div class="comm_cont">
                        <ul>
                            <li><div class="litter_m"><a href="">总公司召开学习十八大精神专</a></div><div class="new_mark">&nbsp;</div><div class="li_right">2014.07.25</div><div style="clear:both;"></div></li>
                            <li><div class="litter_m"><a href="">总公司召开学习十八大精神专</a></div><div class="new_mark">&nbsp;</div><div class="li_right">2014.07.25</div><div style="clear:both;"></div></li>
                            <li><div class="litter_m"><a href="">总公司召开学习十八大精神专</a></div><div class="li_right">2014.07.25</div><div style="clear:both;"></div></li>
                            <li><div class="litter_m"><a href="">总公司召开学习十八大精神专</a></div><div class="li_right">2014.07.25</div><div style="clear:both;"></div></li>
                            <li><div class="litter_m"><a href="">总公司召开学习十八大精神专</a></div><div class="li_right">2014.07.25</div><div style="clear:both;"></div></li>
                            <li><div class="litter_m"><a href="">总公司召开学习十八大精神专</a></div><div class="li_right">2014.07.25</div><div style="clear:both;"></div></li>
                            <li><div class="litter_m"><a href="">总公司召开学习十八大精神专</a></div><div class="li_right">2014.07.25</div><div style="clear:both;"></div></li>
