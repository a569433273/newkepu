...
function covert_table(id_name){
		...
		if(id_name2.style.display==""){
			id_name3.innerHTML="<span>退改签费用标准&nbsp;<img src='img/down.jpg' style='margin-bottom:-5px;'/></span>";
			id_name2.style.display="none";
			}
		else{
		  id_name3.innerHTML="<span>退改签费用标准&nbsp;<img src='img/up.png' style='margin-bottom:-5px;'/></span>";
