...
function ck_regFm(){	
 ...
 var id1_nm=document.getElementById("u_pwd").value;
	...
	if(id1_nm==id2_nm && id1_nm!="" && id2_nm!=""){
	   ...
	   if(id1_nm=="" || id2_nm==""){document.getElementById("ck_pwd1").innerHTML="<img src='../images/wrong_ck.jpg' style='margin-top:10px;'/>"; flag1=1;}
		if(id1_nm!="" && id2_nm!=""){
...
//短信
  var msg=document.getElementById("u_msg").value;
  if(msg==""){
	 document.getElementById("ck_msg").innerHTML="<img src='../images/wrong_ck.jpg' style='margin-top:10px;'/>&nbsp;";
		flag3=1;
	  }
	 else{
		document.getElementById("ck_msg").innerHTML="<img src='../images/right_ck.jpg' style='margin-top:10px;'/>&nbsp;"; 
		 }
//邀请吗
var cd=document.getElementById("u_weck").value;
...
if(cd=="" || cd_len!=6){
	...
	document.getElementById("ck_weck").innerHTML="<img src='../images/right_ck.jpg' style='margin-top:10px;'/>";
	}
//验证码
var cd=document.getElementById("u_code").value;
if(cd==""){
	 document.getElementById("ck_code").innerHTML="<img src='../images/wrong_ck.jpg' style='margin-top:10px;'/>&nbsp;";
		flag5=1;
	}
else{
	document.getElementById("ck_code").innerHTML="<img src='../images/right_ck.jpg' style='margin-top:10px;'/>&nbsp;";
	}
	if(flag==0 && flag1==0 && flag2==0 && flag3==0 && flag4==0 && flag5==0){return true;}else{return false;}
	}